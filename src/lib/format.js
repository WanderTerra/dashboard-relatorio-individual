...
exports.agentIdNameMap = exports.itemNameMap = void 0;
...
function formatItemName(technicalName) {
    if (!technicalName)
        return "";
    // Se existir no mapa, retorna o valor mapeado
    if (exports.itemNameMap[technicalName]) {
        return exports.itemNameMap[technicalName];
    }
...
function formatAgentName(agent) {
    var _a;
    if (!agent)
        return "Agente sem nome";
    // Verificar se o ID do agente está no mapeamento de correção
    var agentId = (_a = agent.agent_id) === null || _a === void 0 ? void 0 : _a.toString();
    if (agentId && exports.agentIdNameMap[agentId]) {
        return exports.agentIdNameMap[agentId];
    }
    ...
    return agentId ? "Agente ".concat(agentId) : "Agente sem nome";
}
// Mapeamento de IDs de agentes para nomes corretos
exports.agentIdNameMap = {
    "1011": "Adryan Araujo",
    "1112": "Anny Danielli",
    "1099": "Arthur Marques",
    "1103": "Cayo Eduardo",

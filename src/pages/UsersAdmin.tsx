    ...
    <ModalBody>
      <ModalContent>
        ...
        <div className="mb-4">
          ...
          <input
            className="border border-gray-300 px-2 py-1 rounded-xl w-full shadow-sm bg-white !text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            value={newUsername}

...
var DrawerContent = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(DrawerPortal, { children: [(0, jsx_runtime_1.jsx)(DrawerOverlay, {}), (0, jsx_runtime_1.jsxs)(vaul_1.Drawer.Content, __assign({ ref: ref, className: (0, utils_1.cn)("fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950", className) }, props, { children: [(0, jsx_runtime_1.jsx)("div", { className: "mx-auto mt-4 h-2 w-[100px] rounded-full bg-zinc-100 dark:bg-zinc-800" }), children] }))] }));
});
...
var DrawerDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)(vaul_1.Drawer.Description, __assign({ ref: ref, className: (0, utils_1.cn)("text-sm text-zinc-500 dark:text-zinc-400", className) }, props)));
});

...
var Carousel = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(CarouselContext.Provider, { value: {
        ...
        }, children: (0, jsx_runtime_1.jsx)("div", __assign({ ref: ref, onKeyDownCapture: handleKeyDown, className: (0, utils_1.cn)("relative", className), role: "region", "aria-roledescription": "carousel" }, props, { children: children })) }));
});
...
var CarouselContent = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { ref: carouselRef, className: "overflow-hidden", children: (0, jsx_runtime_1.jsx)("div", __assign({ ref: ref, className: (0, utils_1.cn)("flex", orientation === "horizontal" ? "-ml-4" : "-mt-4 flex-col", className) }, props)) }));
});
...
var CarouselItem = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ ref: ref, role: "group", "aria-roledescription": "slide", className: (0, utils_1.cn)("min-w-0 shrink-0 grow-0 basis-full", orientation === "horizontal" ? "pl-4" : "pt-4", className) }, props)));
});
...
var CarouselPrevious = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(button_1.Button, __assign({ ref: ref, variant: variant, size: size, className: (0, utils_1.cn)("absolute  h-8 w-8 rounded-full", orientation === "horizontal"

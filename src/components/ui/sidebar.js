...
var Sidebar = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, className: "group peer hidden md:block text-sidebar-foreground", "data-state": state, "data-collapsible": state === "collapsed" ? collapsible : "", "data-variant": variant, "data-side": side, children: [(0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("duration-200 relative h-svh w-[--sidebar-width] bg-transparent transition-[width] ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" || variant === "inset"
                    ...
                    : "group-data-[collapsible=icon]:w-[--sidebar-width-icon]") }), (0, jsx_runtime_1.jsx)("div", __assign({ className: (0, utils_1.cn)("duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex", side === "left"
...
var SidebarInput = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)(input_1.Input, __assign({ ref: ref, "data-sidebar": "input", className: (0, utils_1.cn)("h-8 w-full bg-white shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring dark:bg-zinc-950", className) }, props)));
});
...
var SidebarGroupLabel = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Comp, __assign({ ref: ref, "data-sidebar": "group-label", className: (0, utils_1.cn)("duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0", className) }, props)));
});
...
var SidebarMenuBadge = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("div", __assign({ ref: ref, "data-sidebar": "menu-badge", className: (0, utils_1.cn)("absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none", "peer-hover/menu-button:text-sidebar-accent-foreground peer-data-[active=true]/menu-button:text-sidebar-accent-foreground", "peer-data-[size=sm]/menu-button:top-1", "peer-data-[size=default]/menu-button:top-1.5", "peer-data-[size=lg]/menu-button:top-2.5", "group-data-[collapsible=icon]:hidden", className) }, props)));
});
...
var SidebarMenuSkeleton = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ ref: ref, "data-sidebar": "menu-skeleton", className: (0, utils_1.cn)("rounded-md h-8 flex gap-2 px-2 items-center", className) }, props, { children: [showIcon && ((0, jsx_runtime_1.jsx)(skeleton_1.Skeleton, { className: "size-4 rounded-md", "data-sidebar": "menu-skeleton-icon" })), (0, jsx_runtime_1.jsx)(skeleton_1.Skeleton, { className: "h-4 flex-1 max-w-[--skeleton-width]", "data-sidebar": "menu-skeleton-text", style: {
